...
var Cmajor = ['C4','D4','E4','F4','G4','A4','B4','C5'];
  ...
  // Initialize Firebase
  var config = {
    apiKey: "AIzaSyBdNsvQceZccXdW_jCEliIOzOXkeYB0hbg",
    authDomain: "musicnote-50058.firebaseapp.com",
    databaseURL: "https://musicnote-50058.firebaseio.com",
    projectId: "musicnote-50058",
    storageBucket: "musicnote-50058.appspot.com",
    messagingSenderId: "1046345778394"
  };
var defaultApp = firebase.initializeApp(config);
var dataFirebase = defaultApp.database();
...
finish.addEventListener('click', function(e) {
    ...
    firebase.database().ref('musicnote-50058/'+ userId).set({
        notes: userNotes,
    });
});
